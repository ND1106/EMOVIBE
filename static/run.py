...
def pred_and_plot(class_names):
    ...
    while time.time() - start_time < 20:
        ...
        cv2.putText(img, f"Prediction: {pred_class}", (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
...
pred_and_plot(Emotion_Classes)
Recommend_Songs(most_common_pred_global)